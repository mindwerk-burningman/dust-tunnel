...
public class osctomidi extends PApplet {
    ...
    public void setup() {
        ...
        midiBus = new MidiBus(this, -1, "MIDI Monitor (Untitled)"); // Create a new MidiBus with no input device and the default Java Sound Synthesizer as the output device.
    }
